...
huntHill.PointArrayStatus = ['ps', 'pT', 'pts', 'u', 'u_x']
...
# get color transfer function/color map for 'u_x'
u_xLUT = GetColorTransferFunction('u_x')
u_xPWF = GetOpacityTransferFunction('u_x')
u_xPWF.ApplyPreset('Parula', True)
u_xLUT.InvertTransferFunction()
...
# set scalar coloring
ColorBy(clip2Display, ('POINTS', 'u_x'))
...
# set scalar coloring
ColorBy(clip4Display, ('POINTS', 'u_x'))
...
# get color legend/bar for u_xLUT in view renderView1
u_xLUTColorBar = GetScalarBar(u_xLUT, renderView1)
u_xLUTColorBar.ScalarBarLength = 0.6
u_xLUTColorBar.WindowLocation = 'UpperRightCorner'
u_xLUTColorBar_1 = GetScalarBar(u_xLUT, renderView2)
u_xLUTColorBar_1.ScalarBarLength = 0.6
u_xLUTColorBar_1.WindowLocation = 'UpperRightCorner'
...
streamTracer1Display.ColorArrayName = ['POINTS', 'u_x']
